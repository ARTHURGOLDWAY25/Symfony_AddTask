 ...
 */
class getAddTaskControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\AddTaskController' shared autowired service.
     *
     * @return \App\Controller\AddTaskController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AddTaskController.php';

        $container->services['App\\Controller\\AddTaskController'] = $instance = new \App\Controller\AddTaskController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'twig' => '?',
        ]))->withContext('App\\Controller\\AddTaskController', $container));
