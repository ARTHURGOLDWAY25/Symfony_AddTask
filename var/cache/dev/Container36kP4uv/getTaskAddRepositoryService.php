 ...
 */
class getTaskAddRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaskAddRepository' shared autowired service.
     *
     * @return \App\Repository\TaskAddRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaskAddRepository.php';

        return $container->privates['App\\Repository\\TaskAddRepository'] = new \App\Repository\TaskAddRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
